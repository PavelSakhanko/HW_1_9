...
*/
- (void)listIngredients:(NSString *)ingredients query:(NSString *)query page:(int32_t)page completionHandler:(void (^)(SharedRecipeList * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("list(ingredients:query:page:completionHandler:)")));
@end;
